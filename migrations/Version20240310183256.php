 ...
 */
final class Version20240310183256 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, finance_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, amount NUMERIC(10, 0) NOT NULL, INDEX IDX_64C19C1727ACA70 (parent_id), UNIQUE INDEX UNIQ_64C19C15E87A6C2 (finance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
